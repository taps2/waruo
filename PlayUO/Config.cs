...
namespace PlayUO
{
  public class Config
  {
    private static string[] m_FileNames = new string[28]{ "Skills.idx", "Skills.mul", "Body.def", "SoundIdx.mul", "Sound.mul", "LightIdx.mul", "Light.mul", "Fonts.mul", "TileData.mul", "Anim.idx", "Anim.mul", "ArtIdx.mul", "Art.mul", "TexIdx.mul", "TexMaps.mul", "Hues.mul", "Multi.idx", "Multi.mul", "Map0.mul", "Map2.mul", "Statics0.mul", "Statics2.mul", "StaIdx0.mul", "StaIdx2.mul", "AnimData.mul", "VerData.mul", "GumpIdx.mul", "GumpArt.mul" };
